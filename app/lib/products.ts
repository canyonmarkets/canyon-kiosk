...
export const PRODUCTS: Product[] = [
  ...
  // ── Drinks ──
  { id: 'coke-20oz',         name: 'Coca-Cola 20oz',                  price: 2.25, category: 'drinks',   upc: '049000028935', available: true },
  { id: 'pepsi-20oz',        name: 'Pepsi 20oz',                      price: 2.25, category: 'drinks',   upc: '012000001765', available: true },
  { id: 'mtn-dew-20oz',      name: 'Mountain Dew 20oz',               price: 2.25, category: 'drinks',   upc: '012000007569', available: true },
  { id: 'sprite-20oz',       name: 'Sprite 20oz',                     price: 2.25, category: 'drinks',   upc: '049000028904', available: true },
  { id: 'gatorade-fruit',    name: 'Gatorade Fruit Punch 20oz',       price: 2.50, category: 'drinks',   upc: '052000328941', available: true },
  { id: 'gatorade-lemon',    name: 'Gatorade Lemon Lime 20oz',        price: 2.50, category: 'drinks',   upc: '052000113101', available: true },
  { id: 'dasani-20oz',       name: 'Dasani Water 20oz',               price: 1.75, category: 'drinks',   upc: '049000028904', available: true },
  { id: 'oj-12oz',           name: 'Minute Maid Orange Juice 12oz',   price: 2.25, category: 'drinks',   upc: '025000048586', available: true },
  ...
  { id: 'cheezit',           name: 'Cheez-It Original 3oz',           price: 1.75, category: 'crackers', upc: '024100106363', available: true },
  { id: 'planters',          name: 'Planters Peanuts 1.75oz',         price: 1.25, category: 'crackers', upc: '029000015524', available: true },
  { id: 'trail-mix',         name: 'Trail Mix 1.5oz',                 price: 2.00, category: 'crackers', upc: '077975070932', available: true },
...
export const CATEGORIES: Record<string, { label: string; icon: string }> = {
  ...
  drinks:   { label: 'Drinks',        icon: '/Soda.png' },
  chips:    { label: 'Chips',         icon: '/Chips.png' },
  crackers: { label: 'Nuts & Crackers', icon: '/Crackers.png' },
